...
This is a downstream analysis pipeline for the **pion elliptic flow coalescence test** in BES-II Au+Au collisions. The pipeline is orchestrated by Snakemake and processes ROOT data through C++/Python scripts to extract the coalescence ratio $N_d^{tr}/N_u^{tr}$ from pion $v_2$ measurements.

For detailed documentation, see:
- [docs/physics.md](docs/physics.md) - Physics motivation, coalescence model, key equations
- [docs/pipeline.md](docs/pipeline.md) - Snakemake DAG, rule descriptions, how to run
